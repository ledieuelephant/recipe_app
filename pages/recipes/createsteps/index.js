...
export default function createSteps({recipes}){
    useEffect(() => {
        console.log(recipes)
    })
    return <div>
        ...
        <div className="container mx-auto">
            <div class="grid gap-4 gap-y-8 md:grid-cols-2 lg:grid-cols-3 mb-16">
                ...
                <div class="p-4">
                    ...
                    <a href={"/recipes/createsteps/"+recipe.id}><button class="text-white bg-green-400 p-4 rounded-md w-full uppercase">Add steps</button></a>
                </div>
